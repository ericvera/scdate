...
it('should return the same timestamp if already available', () => {
  ...
  const result = getNextAvailableFromSchedule(schedule, timestamp)
...
it('should handle indefinite overrides before override starts', () => {
  ...
  const resultBefore = getNextAvailableFromSchedule(schedule, before)
...
it('should handle indefinite overrides after override starts', () => {
  ...
  const resultAfter = getNextAvailableFromSchedule(schedule, after)
